...
- Follow [SECURITY.md](SECURITY.md) for vulnerabilities; never report them publicly first.

Before asking for help, read [README.md](README.md), verify that you are on macOS 14 or later, and try a clean build with:
