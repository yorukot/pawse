...
final class BreakBackgroundService: BreakBackgroundProviding {
    ...
    func selectCustomImage(at url: URL) {
        ...
        do {
            ...
            errorMessage = "Pawse could not use or remember access to that image. Choose it again."
        }
    }
    ...
    func selectWallpaperFolder(at url: URL) {
        ...
        do {
            ...
            errorMessage = "Pawse could not remember access to that folder. Choose it again."
        }
    }
    ...
    private static func wallpaperFailureMessage(
        ...
        return "Pawse needs access to the folder containing this wallpaper. Choose Wallpaper Folder in Appearance."
    }
