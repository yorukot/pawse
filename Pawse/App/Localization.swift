        ...
        NSWorkspace.shared.openApplication(
            ...
            Task { @MainActor [weak self] in
                ...
                if succeeded {
                    ...
                    self.errorMessage = "Pawse could not restart: \(failureDescription). The new language will be used the next time you open Pawse."
                } else {
                    self.errorMessage = "Pawse could not restart. The new language will be used the next time you open Pawse."
                }
            }
        }
    }
