...
final class BreakBackgroundServiceTests: XCTestCase {
    func testCustomImageUsesReloadableReadOnlySecurityScopedBookmark() throws {
        ...
        let folderURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("BreatherBackgroundTests-(UUID().uuidString)", isDirectory: true)
    ...
    func testWallpaperFolderUsesReloadableReadOnlySecurityScopedBookmark() throws {
        ...
        let folderURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("BreatherWallpaperTests-(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: folderURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: folderURL) }
    ...
    private func isolatedDefaults() -> (UserDefaults, String) {
        let suiteName = "BreatherBackgroundTests.(UUID().uuidString)"
